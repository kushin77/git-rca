...
class TestInvestigationModel:
    ...
    def test_investigation_unlink_event(self):
        ...
        inv = Investigation(id="inv-009", title="Test", event_ids=["evt-001", "evt-002"])
...
class TestEventModel:
    ...
    def test_event_severities(self):
        ...
        for severity in severities:
            event = Event(timestamp=now, source=EventSource.LOGS, event_type="test", severity=severity)
