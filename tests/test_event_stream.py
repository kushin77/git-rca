...
class TestEventStreamIntegration:
    ...
    def test_complex_subscription_scenario(self):
        ...
        events = [
            CanvasChangeEvent(event_type=EventType.NODE_ADDED, canvas_id="canvas-1", user_id="user-1"),
            CanvasChangeEvent(event_type=EventType.EDGE_ADDED, canvas_id="canvas-1", user_id="user-2"),
            CanvasChangeEvent(event_type=EventType.NODE_ADDED, canvas_id="canvas-2", user_id="user-1"),
            CanvasChangeEvent(event_type=EventType.CANVAS_UPDATED, canvas_id="canvas-1", user_id="user-1"),
        ]
        ...
        assert len(user1_events) == 3    # NODE_ADDED (c1), NODE_ADDED (c2), CANVAS_UPDATED
