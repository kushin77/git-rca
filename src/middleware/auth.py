...
class TokenValidator:
    ...
    def generate_token(
        self, user_id: str, role: str = "engineer", expires_in_hours: int = 24
    ) -> str:
        """
        ...
        payload_b64 = (
            base64.urlsafe_b64encode(payload_str.encode()).decode().rstrip("=")
        )
...
def init_auth(app):
    ...
    def logout():
        ...
        try:
            ...
            return (
                jsonify({"message": "Successfully logged out", "user_id": user_id}),
                200,
            )
