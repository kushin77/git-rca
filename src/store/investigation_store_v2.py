...
from src.models.investigation import (
    Investigation, InvestigationStatus, ImpactSeverity, Priority
)
...
class InvestigationStore:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                ''', (
                    ...
                    json.dumps(investigation.event_ids) if investigation.event_ids else None,
                    json.dumps(investigation.related_investigation_ids) if investigation.related_investigation_ids else None,
    ...
    def get_investigations_by_severity(self, severity: ImpactSeverity) -> List[Investigation]:
        """
    ...
    def update_investigation(self, investigation_id: str, updates: Dict[str, Any]) -> bool:
        """
    ...
    def get_all_investigations(self, include_deleted: bool = False) -> List[Investigation]:
        """
