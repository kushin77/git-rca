...
# Files to skip
EXCLUDED_DIRS = {'.git', '.venv', '__pycache__', '.pytest_cache', 'logs', 'node_modules', '.egg-info'}
EXCLUDED_FILES = {'.env.example', '.env.local', '.secrets.baseline', 'requirements.txt', 'package-lock.json', 'poetry.lock'}
EXCLUDED_EXTENSIONS = {'.pyc', '.so', '.o', '.a', '.png', '.jpg', '.jpeg', '.gif', '.zip', '.tar', '.gz'}
